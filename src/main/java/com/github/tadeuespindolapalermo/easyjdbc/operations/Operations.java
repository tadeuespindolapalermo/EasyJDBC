...
public class Operations {
	...
	protected String mountQueryInsert(Map<String, ?> columnsAndValues, String tableName) {
		...
		StringBuilder sql = new StringBuilder("INSERT INTO ").append(tableName).append(" (" + columnsName + ") ")
				.append("VALUES").append(" (" + values + ") ");

		return sql.toString();
	}

	protected String mountQueryUpdate(Map<String, ?> columnsAndValues, Map<String, ?> clauseColumnAndValue,
			String tableName) {
	...
	protected String mountQueryDelete(String table, String column, Object value) {
		...
		StringBuilder sql = new StringBuilder("DELETE FROM ").append(table).append(WHERE_CLAUSE).append(column)
				.append(" = ").append("'" + value + "'");
